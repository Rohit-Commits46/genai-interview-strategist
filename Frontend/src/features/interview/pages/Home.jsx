                        ...
                        <div className='upload-section'>
                            ...
                            {selectedFile ? (
                                <div className='dropzone dropzone--selected'>
                                    ...
                                    <p className='dropzone__title dropzone__title--success'>{selectedFile}</p>
                                    <p className='dropzone__subtitle'>File ready for upload</p>
                                    <button type='button' className='dropzone__remove' onClick={(e) => {
                                        e.stopPropagation()
                            ...
                            <input ref={resumeInputRef} type='file' id='resume' name='resume' accept='.pdf,.docx' hidden
                                onChange={(e) => {
